...
if __name__ == "__main__":
	...
	#~ #taxons des reads finissent par _#, l'enlever pour pouvoir comparer les arbres restreints.
	f2 = open(outputname+"_output_restrictedTrees_placed","r")
	f3 = open(outputname+"_output_restrictedTrees_placed_checked", "w")
	patternlist = ["_0", "_1", "_2", "_3", "_4", "_5", "_6", "_7", "_8", "_9"]
	...
	print "Restricted trees of <<<",outputname,">>> done.\n"
